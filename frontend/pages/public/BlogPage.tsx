      ...
      {featuredPost && (
        <div className="px-4 pb-12">
          <div className="container mx-auto">
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/20 hover:border-purple-400/50 transition-all cursor-pointer group"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  <Badge className="bg-pink-500/20 text-pink-400 border-pink-500/50 w-fit mb-4">
                    {featuredPost.category}
                  </Badge>
                  <h2 className="text-3xl md:text-4xl text-white mb-4 group-hover:text-purple-400 transition-colors">
                    {featuredPost.title}
                  </h2>
        ...
        <div className="container mx-auto">
          {filteredPosts.length === 0 ? (
            <div className="text-center py-20">
              ...
              <p className="text-white/70 text-xl">Không tìm thấy bài viết phù hợp</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredPosts.map(post => (
                <div
                  ...
                  className="bg-white/10 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/20 hover:border-purple-400/50 transition-all cursor-pointer group"
                >
                  <div className="relative h-48">
                    <img
                      ...
                      className="w-full h-full object-cover"
                    />
                    <Badge className="absolute top-4 left-4 bg-purple-500/20 text-purple-400 border-purple-500/50">
                      {post.category}
                    </Badge>
                  </div>
                  <div className="p-6">
